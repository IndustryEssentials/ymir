const task = {
  ...
  "task.action.stop": { cn: "终止任务", en: "Terminate", },
  "task.action.copy": { cn: "复制任务", en: "Copy", },
  ...
  "task.train.form.repeatdata.terminate": { cn: "终止训练", en: "Terminate Train", },
  ...
  "task.mining.form.topk.label": { cn: "得分TOPK", en: "Scount TOP K", },
