...
class MirCode(IntEnum):
    ...
    RC_CMD_PERMISSION_DENIED = 160019  # todo
    RC_CMD_DOCKER_SERVICE_ERROR = 160020  # todo
    RC_CMD_DATASET_LACK_REQUIRED_ITEMS = 160021  # todo
    RC_CMD_MODEL_LACK_REQUIRED_ITEMS = 160022  # todo
