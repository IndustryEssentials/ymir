...
from mir.tools import mir_storage, settings as mir_settings
...
def find_extra_items(mir_root: str) -> List[str]:
    ...
    return list(set(items) - set(mir_storage.get_all_mir_paths()) - set(mir_settings.MIR_ASSOCIATED_FILES))
