...
from mir.tools import checker, class_ids, mir_repo_utils, mir_storage, mir_storage_ops, revs_parser, utils as mir_utils
...
class CmdFilter(base.BaseCommand):
    ...
    def run_with_args(mir_root: str, in_cis: Optional[str], ex_cis: Optional[str], src_revs: str, dst_rev: str,
        ...
        mir_utils.copy_annotations_pred_meta(src_task_annotations=mir_annotations.prediction,
                                             dst_task_annotations=matched_mir_annotations.prediction)
