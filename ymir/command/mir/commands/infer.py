...
from mir.tools.annotations import single_image_annotations_available, import_annotations_coco_json, UnknownTypesStrategy
...
def _process_infer_detbox_result(task_annotations: mirpb.SingleTaskAnnotations, work_dir_out: str,
    ...
    for asset_name, annotations_dict in detections.items():
        ...
        if single_image_annotations_available(single_image_annotations):
