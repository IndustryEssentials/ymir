...
_OBJECTANNOTATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='height', full_name='mir.command.ObjectAnnotation.height', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='width', full_name='mir.command.ObjectAnnotation.width', index=15,
...
_ANNOSTATS = _descriptor.Descriptor(
  ...
  nested_types=[_ANNOSTATS_TAGSCNTENTRY, _ANNOSTATS_CLASSIDSCNTENTRY, _ANNOSTATS_CLASSIDSMASKAREAENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
