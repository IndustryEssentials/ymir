...
_MIRKEYWORDS = _descriptor.Descriptor(
  ...
  nested_types=[_MIRKEYWORDS_KEYWORDSENTRY, _MIRKEYWORDS_INDEXPREDEFINEDKEYIDSENTRY, _MIRKEYWORDS_INDEXCUSTOMIZEDKEYWORDSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
