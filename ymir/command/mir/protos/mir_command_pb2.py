...
_SINGLEDATASETEVALUATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='conf_threshold', full_name='mir.command.SingleDatasetEvaluation.conf_threshold', index=0,
