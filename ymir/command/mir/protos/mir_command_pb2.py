...
_IMPORTEXPORTFORMAT = _descriptor.EnumDescriptor(
  name='ImportExportFormat',
  full_name='mir.command.ImportExportFormat',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      name='IEF_NO_ANNOTATIONS', index=0, number=0,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='IEF_VOC_XML', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='IEF_ARK_TXT', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='IEF_LS_JSON', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='IEF_COCO_JSON', index=4, number=4,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_IMPORTEXPORTFORMAT)

ImportExportFormat = enum_type_wrapper.EnumTypeWrapper(_IMPORTEXPORTFORMAT)
...
_EXPORTCONFIG.fields_by_name['anno_format'].enum_type = _IMPORTEXPORTFORMAT
...
DESCRIPTOR.enum_types_by_name['ImportExportFormat'] = _IMPORTEXPORTFORMAT
