...
_SINGLETOPICTOTALSUBEVALUATION_SUBENTRY = _descriptor.Descriptor(
  name='SubEntry',
  full_name='mir.command.SingleTopicTotalSubEvaluation.SubEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mir.command.SingleTopicTotalSubEvaluation.SubEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='mir.command.SingleTopicTotalSubEvaluation.SubEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SINGLETOPICTOTALSUBEVALUATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sub', full_name='mir.command.SingleTopicTotalSubEvaluation.sub', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_SINGLETOPICTOTALSUBEVALUATION_SUBENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SINGLETOPICTOTALSUBEVALUATION_SUBENTRY.fields_by_name['value'].message_type = _SINGLETOPICEVALUATION
_SINGLETOPICTOTALSUBEVALUATION_SUBENTRY.containing_type = _SINGLETOPICTOTALSUBEVALUATION
_SINGLETOPICTOTALSUBEVALUATION.fields_by_name['total'].message_type = _SINGLETOPICEVALUATION
_SINGLETOPICTOTALSUBEVALUATION.fields_by_name['sub'].message_type = _SINGLETOPICTOTALSUBEVALUATION_SUBENTRY
...
SingleTopicTotalSubEvaluation = _reflection.GeneratedProtocolMessageType('SingleTopicTotalSubEvaluation', (_message.Message,), {
  ...
  'SubEntry' : _reflection.GeneratedProtocolMessageType('SubEntry', (_message.Message,), {
    'DESCRIPTOR' : _SINGLETOPICTOTALSUBEVALUATION_SUBENTRY,
    '__module__' : 'mir_command_pb2'
    # @@protoc_insertion_point(class_scope:mir.command.SingleTopicTotalSubEvaluation.SubEntry)
    })
  ,
...
_sym_db.RegisterMessage(SingleTopicTotalSubEvaluation.SubEntry)
...
_SINGLETOPICTOTALSUBEVALUATION_SUBENTRY._options = None
