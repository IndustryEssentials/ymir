...
_EVALUATION_IOUEVALUATIONSENTRY = _descriptor.Descriptor(
  name='IouEvaluationsEntry',
  full_name='mir.command.Evaluation.IouEvaluationsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='mir.command.Evaluation.IouEvaluationsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='mir.command.Evaluation.IouEvaluationsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EVALUATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='conf_threshold', full_name='mir.command.Evaluation.conf_threshold', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='iou_evaluations', full_name='mir.command.Evaluation.iou_evaluations', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='average_evaluation', full_name='mir.command.Evaluation.average_evaluation', index=2,
  ...
  nested_types=[_EVALUATION_IOUEVALUATIONSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_EVALUATION_IOUEVALUATIONSENTRY.fields_by_name['value'].message_type = _SINGLEIOUEVALUATION
_EVALUATION_IOUEVALUATIONSENTRY.containing_type = _EVALUATION
_EVALUATION.fields_by_name['iou_evaluations'].message_type = _EVALUATION_IOUEVALUATIONSENTRY
_EVALUATION.fields_by_name['average_evaluation'].message_type = _SINGLEIOUEVALUATION
...
Evaluation = _reflection.GeneratedProtocolMessageType('Evaluation', (_message.Message,), {
  ...
  'IouEvaluationsEntry' : _reflection.GeneratedProtocolMessageType('IouEvaluationsEntry', (_message.Message,), {
    'DESCRIPTOR' : _EVALUATION_IOUEVALUATIONSENTRY,
    '__module__' : 'mir_command_pb2'
    # @@protoc_insertion_point(class_scope:mir.command.Evaluation.IouEvaluationsEntry)
    })
  ,
...
_sym_db.RegisterMessage(Evaluation.IouEvaluationsEntry)
...
_EVALUATION_IOUEVALUATIONSENTRY._options = None
