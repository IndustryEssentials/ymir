...
class InferResultAnnotations(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PREDICTION_FIELD_NUMBER: builtins.int
    UNKNOWN_TYPES_PREDICTION_FIELD_NUMBER: builtins.int
    @property
    def prediction(self) -> global___SingleTaskAnnotations: ...
    @property
    def unknown_types_prediction(self) -> global___SingleTaskAnnotations: ...
    def __init__(self,
        *,
        prediction : typing.Optional[global___SingleTaskAnnotations] = ...,
        unknown_types_prediction : typing.Optional[global___SingleTaskAnnotations] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["prediction",b"prediction","unknown_types_prediction",b"unknown_types_prediction"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["prediction",b"prediction","unknown_types_prediction",b"unknown_types_prediction"]) -> None: ...
global___InferResultAnnotations = InferResultAnnotations
