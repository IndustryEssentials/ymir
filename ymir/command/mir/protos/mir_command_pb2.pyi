...
class Evaluation(google.protobuf.message.Message):
    ...
    IOU_EVALUATION_FIELD_NUMBER: builtins.int
    conf_threshold: builtins.float = ...
    @property
    def iou_evaluation(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SingleIouEvaluation]: ...
    def __init__(self,
        *,
        conf_threshold : builtins.float = ...,
        iou_evaluation : typing.Optional[typing.Iterable[global___SingleIouEvaluation]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["conf_threshold",b"conf_threshold","iou_evaluation",b"iou_evaluation"]) -> None: ...
