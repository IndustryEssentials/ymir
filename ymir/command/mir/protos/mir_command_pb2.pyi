...
class SingleTopicEvaluation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["average_percision",b"average_percision","average_recall",b"average_recall","fn",b"fn","fp",b"fp","pr_curve",b"pr_curve","tp",b"tp"]) -> None: ...
