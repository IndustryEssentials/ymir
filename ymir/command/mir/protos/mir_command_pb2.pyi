...
class Task(google.protobuf.message.Message):
    ...
    @property
    def task_context(self) -> global___TaskContext: ...
    def __init__(self,
        *,
        type : global___TaskType.V = ...,
        name : typing.Text = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ancestor_task_id",b"ancestor_task_id","base_task_id",b"base_task_id","executor_config",b"executor_config","model",b"model","name",b"name","return_code",b"return_code","return_msg",b"return_msg","task_context",b"task_context","task_id",b"task_id","task_parameters",b"task_parameters","timestamp",b"timestamp","type",b"type","unknown_types",b"unknown_types"]) -> None: ...
global___Task = Task
