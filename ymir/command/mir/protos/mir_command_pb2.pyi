...
class MirAnnotations(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ground_truth",b"ground_truth","head_task_id",b"head_task_id","prediction",b"prediction","task_annotations",b"task_annotations"]) -> None: ...
...
class SingleImageAnnotations(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["annotations",b"annotations","cks",b"cks"]) -> None: ...
...
class MirKeywords(google.protobuf.message.Message):
    ...
    PRED_ASSET_IDX_FIELD_NUMBER: builtins.int
    GT_ASSET_IDX_FIELD_NUMBER: builtins.int
    PRED_ASSET_ANNO_IDX_FIELD_NUMBER: builtins.int
    GT_ASSET_ANNO_IDX_FIELD_NUMBER: builtins.int
    @property
    def keywords(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Keywords]:
        ...
        pass
    @property
    def index_predefined_keyids(self) -> google.protobuf.internal.containers.MessageMap[builtins.int, global___Assets]:
        """key: class id, value: assert ids"""
        pass
    @property
    def pred_asset_idx(self) -> global___KeywordIndexedAssets: ...
    @property
    def gt_asset_idx(self) -> global___KeywordIndexedAssets: ...
    @property
    def pred_asset_anno_idx(self) -> global___KeywordIndexedAnnos: ...
    @property
    def gt_asset_anno_idx(self) -> global___KeywordIndexedAnnos: ...
    def __init__(self,
        *,
        keywords : typing.Optional[typing.Mapping[typing.Text, global___Keywords]] = ...,
        index_predefined_keyids : typing.Optional[typing.Mapping[builtins.int, global___Assets]] = ...,
        pred_asset_idx : typing.Optional[global___KeywordIndexedAssets] = ...,
        gt_asset_idx : typing.Optional[global___KeywordIndexedAssets] = ...,
        pred_asset_anno_idx : typing.Optional[global___KeywordIndexedAnnos] = ...,
        gt_asset_anno_idx : typing.Optional[global___KeywordIndexedAnnos] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["gt_asset_anno_idx",b"gt_asset_anno_idx","gt_asset_idx",b"gt_asset_idx","pred_asset_anno_idx",b"pred_asset_anno_idx","pred_asset_idx",b"pred_asset_idx"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["gt_asset_anno_idx",b"gt_asset_anno_idx","gt_asset_idx",b"gt_asset_idx","index_predefined_keyids",b"index_predefined_keyids","keywords",b"keywords","pred_asset_anno_idx",b"pred_asset_anno_idx","pred_asset_idx",b"pred_asset_idx"]) -> None: ...
global___MirKeywords = MirKeywords

class KeywordIndexedAssets(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    class CksEntry(google.protobuf.message.Message):
        ...
        key: typing.Text = ...
        @property
        def value(self) -> global___SingleCkAssets: ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___SingleCkAssets] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    CKS_FIELD_NUMBER: builtins.int
    @property
    def cis(self) -> google.protobuf.internal.containers.MessageMap[builtins.int, global___Assets]:
        """key: ci, value: assets"""
        pass
    @property
    def cks(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___SingleCkAssets]:
        """key: ck main key, value: assets and assets of sub keys"""
        pass
    def __init__(self,
        *,
        cis : typing.Optional[typing.Mapping[builtins.int, global___Assets]] = ...,
        cks : typing.Optional[typing.Mapping[typing.Text, global___SingleCkAssets]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["cis",b"cis","cks",b"cks"]) -> None: ...
global___KeywordIndexedAssets = KeywordIndexedAssets

class KeywordIndexedAnnos(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class CisEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        KEY_FIELD_NUMBER: builtins.int
        ...
        key: builtins.int = ...
        @property
        def value(self) -> global___SingleCkAnnos: ...
        def __init__(self,
            *,
            key : builtins.int = ...,
            value : typing.Optional[global___SingleCkAnnos] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...
    ...
    CKS_FIELD_NUMBER: builtins.int
    @property
    def cis(self) -> google.protobuf.internal.containers.MessageMap[builtins.int, global___SingleCkAnnos]: ...
    @property
    def cks(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___SingleCkAnnos]: ...
    def __init__(self,
        *,
        cis : typing.Optional[typing.Mapping[builtins.int, global___SingleCkAnnos]] = ...,
        cks : typing.Optional[typing.Mapping[typing.Text, global___SingleCkAnnos]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["cis",b"cis","cks",b"cks"]) -> None: ...
global___KeywordIndexedAnnos = KeywordIndexedAnnos
...
class AssetAnnoIdxes(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ASSET_ANNO_FIELD_NUMBER: builtins.int
    @property
    def asset_anno(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AssetAnno]: ...
    def __init__(self,
        *,
        asset_anno : typing.Optional[typing.Iterable[global___AssetAnno]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["asset_anno",b"asset_anno"]) -> None: ...
global___AssetAnnoIdxes = AssetAnnoIdxes

class AssetAnno(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ASSET_ID_FIELD_NUMBER: builtins.int
    ANNO_IDX_FIELD_NUMBER: builtins.int
    asset_id: typing.Text = ...
    anno_idx: builtins.int = ...
    def __init__(self,
        *,
        asset_id : typing.Text = ...,
        anno_idx : builtins.int = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["anno_idx",b"anno_idx","asset_id",b"asset_id"]) -> None: ...
global___AssetAnno = AssetAnno
...
class SingleCkAssets(google.protobuf.message.Message):
    ...
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class SubAssetsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        KEY_FIELD_NUMBER: builtins.int
        VALUE_FIELD_NUMBER: builtins.int
        key: typing.Text = ...
    ...
    SUB_ASSETS_FIELD_NUMBER: builtins.int
    @property
    def assets(self) -> global___Assets: ...
    @property
    def sub_assets(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___Assets]: ...
    def __init__(self,
        *,
        assets : typing.Optional[global___Assets] = ...,
        sub_assets : typing.Optional[typing.Mapping[typing.Text, global___Assets]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["assets",b"assets"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assets",b"assets","sub_assets",b"sub_assets"]) -> None: ...
global___SingleCkAssets = SingleCkAssets

class SingleCkAnnos(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    class SubAnnoIdxesEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
        KEY_FIELD_NUMBER: builtins.int
        VALUE_FIELD_NUMBER: builtins.int
        key: typing.Text = ...
        @property
        def value(self) -> global___AssetAnnoIdxes: ...
        def __init__(self,
            *,
            key : typing.Text = ...,
            value : typing.Optional[global___AssetAnnoIdxes] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["value",b"value"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["key",b"key","value",b"value"]) -> None: ...

    ANNO_IDXES_FIELD_NUMBER: builtins.int
    SUB_ANNO_IDXES_FIELD_NUMBER: builtins.int
    @property
    def anno_idxes(self) -> global___AssetAnnoIdxes: ...
    @property
    def sub_anno_idxes(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___AssetAnnoIdxes]: ...
    def __init__(self,
        *,
        anno_idxes : typing.Optional[global___AssetAnnoIdxes] = ...,
        sub_anno_idxes : typing.Optional[typing.Mapping[typing.Text, global___AssetAnnoIdxes]] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["anno_idxes",b"anno_idxes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["anno_idxes",b"anno_idxes","sub_anno_idxes",b"sub_anno_idxes"]) -> None: ...
global___SingleCkAnnos = SingleCkAnnos
