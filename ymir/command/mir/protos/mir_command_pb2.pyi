...
class SingleTopicTotalSubEvaluation(google.protobuf.message.Message):
    ...
    @property
    def sub(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___SingleTopicEvaluation]: ...
    def __init__(self,
        *,
        total : typing.Optional[global___SingleTopicEvaluation] = ...,
        sub : typing.Optional[typing.Mapping[typing.Text, global___SingleTopicEvaluation]] = ...,
        ) -> None: ...
