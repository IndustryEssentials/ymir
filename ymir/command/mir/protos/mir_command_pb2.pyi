...
class EvaluateConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["class_ids",b"class_ids","conf_thr",b"conf_thr","iou_thrs_interval",b"iou_thrs_interval","is_instance_segmentation",b"is_instance_segmentation","main_ck",b"main_ck","need_pr_curve",b"need_pr_curve"]) -> None: ...
...
class SegmentationMetrics(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["aacc",b"aacc","acc",b"acc","iou",b"iou"]) -> None: ...
