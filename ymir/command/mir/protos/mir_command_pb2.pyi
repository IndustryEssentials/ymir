...
class EvaluateConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["calc_confusion_matrix",b"calc_confusion_matrix","conf_thr",b"conf_thr","dataset_id",b"dataset_id","iou_thrs_interval",b"iou_thrs_interval","need_pr_curve",b"need_pr_curve"]) -> None: ...
...
class SingleDatasetEvaluation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["conf_thr",b"conf_thr","dataset_id",b"dataset_id","iou_averaged_evaluation",b"iou_averaged_evaluation","iou_evaluations",b"iou_evaluations"]) -> None: ...
