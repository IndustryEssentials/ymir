...
class EvaluateConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["conf_thr",b"conf_thr","gt_dataset_id",b"gt_dataset_id","iou_thr_from",b"iou_thr_from","iou_thr_step",b"iou_thr_step","iou_thr_to",b"iou_thr_to","need_pr_curve",b"need_pr_curve","pred_dataset_ids",b"pred_dataset_ids"]) -> None: ...
