...
class FilterBranchInvoker(BaseMirControllerInvoker):
    ...
    def invoke(self) -> backend_pb2.GeneralResp:
        ...
        if self._request.in_class_ids:
            ...
            filter_command.append(';'.join(self._user_labels.get_main_names(class_ids=list(self._request.in_class_ids))))
        if self._request.ex_class_ids:
            filter_command.append('-P')
            filter_command.append(';'.join(self._user_labels.get_main_names(class_ids=list(self._request.ex_class_ids))))
