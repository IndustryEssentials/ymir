...
Revision ID: 30819241af11
Revises:
Create Date: 2022-02-24 14:50:54.617296
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_dataset_dataset_group_id"),
        "dataset",
        ["dataset_group_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text(length=20000), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("previous_training_dataset_id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("project_id", sa.Integer(), nullable=False),
        sa.Column("is_deleted", sa.Boolean(), nullable=False),
        sa.Column("create_datetime", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_iteration_previous_training_dataset_id"),
        "iteration",
    ...
    op.create_table(
        ...
        sa.Column("training_keywords", sa.Text(length=20000), nullable=True),
        sa.Column("training_dataset_group_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_project_mining_dataset_id"),
        "project",
        ["mining_dataset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_project_training_dataset_group_id"),
        "project",
