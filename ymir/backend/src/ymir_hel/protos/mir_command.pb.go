...
const (
	...
	//OT_SEG sub types
	ObjectType_OT_SEG_MASK    ObjectType = 30
	ObjectType_OT_SEG_POLYGON ObjectType = 31
)
...
type ObjectAnnotation struct {
	...
	Type        ObjectType          `protobuf:"varint,13,opt,name=type,proto3,enum=mir.command.ObjectType" json:"type,omitempty"`
}
...
func (x *ObjectAnnotation) GetType() ObjectType {
	if x != nil {
		return x.Type
	}
	return ObjectType_OT_UNKNOWN
...
var file_mir_command_proto_rawDesc = []byte{
	...
	0x38, 0x01, 0x22, 0x94, 0x04, 0x0a, 0x10, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x6e, 0x6e,
	...
	0x6f, 0x77, 0x64, 0x12, 0x2b, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28,
	...
	0x46, 0x5f, 0x4c, 0x4d, 0x44, 0x42, 0x10, 0x02, 0x2a, 0x6b, 0x0a, 0x0a, 0x4f, 0x62, 0x6a, 0x65,
	...
	,
...
var file_mir_command_proto_goTypes = []interface{}{
	...
	(ExportFormat)(0),               // 8: mir.command.ExportFormat
	...
	(*ExportConfig)(nil),            // 40: mir.command.ExportConfig
	...
	nil,                             // 44: mir.command.SingleImageCks.CksEntry
	nil,                             // 45: mir.command.ObjectAnnotation.TagsEntry
	nil,                             // 46: mir.command.MirKeywords.CkIdxEntry
	nil,                             // 47: mir.command.CiTagToIndex.CisEntry
	nil,                             // 48: mir.command.CiTagToIndex.TagsEntry
	...
	nil,                             // 55: mir.command.Evaluation.SubCksEntry
	nil,                             // 56: mir.command.SingleDatasetEvaluation.IouEvaluationsEntry
	nil,                             // 57: mir.command.SingleIouEvaluation.CiEvaluationsEntry
	nil,                             // 58: mir.command.MirContext.CksCntEntry
	nil,                             // 59: mir.command.SingleMapCount.SubCntEntry
	nil,                             // 60: mir.command.AnnoStats.TagsCntEntry
	nil,                             // 61: mir.command.AnnoStats.ClassIdsCntEntry
}
var file_mir_command_proto_depIdxs = []int32{
	...
	44, // 11: mir.command.SingleImageCks.cks:type_name -> mir.command.SingleImageCks.CksEntry
	19, // 12: mir.command.ObjectAnnotation.box:type_name -> mir.command.Rect
	45, // 13: mir.command.ObjectAnnotation.tags:type_name -> mir.command.ObjectAnnotation.TagsEntry
	9,  // 14: mir.command.ObjectAnnotation.cm:type_name -> mir.command.ConfusionMatrixType
	35, // 15: mir.command.ObjectAnnotation.polygon:type_name -> mir.command.IntPoint
	7,  // 16: mir.command.ObjectAnnotation.type:type_name -> mir.command.ObjectType
	21, // 17: mir.command.MirKeywords.pred_idx:type_name -> mir.command.CiTagToIndex
	21, // 18: mir.command.MirKeywords.gt_idx:type_name -> mir.command.CiTagToIndex
	46, // 19: mir.command.MirKeywords.ck_idx:type_name -> mir.command.MirKeywords.CkIdxEntry
	47, // 20: mir.command.CiTagToIndex.cis:type_name -> mir.command.CiTagToIndex.CisEntry
	48, // 21: mir.command.CiTagToIndex.tags:type_name -> mir.command.CiTagToIndex.TagsEntry
	49, // 22: mir.command.MapStringToInt32List.key_ids:type_name -> mir.command.MapStringToInt32List.KeyIdsEntry
	50, // 23: mir.command.AssetAnnoIndex.asset_annos:type_name -> mir.command.AssetAnnoIndex.AssetAnnosEntry
	51, // 24: mir.command.AssetAnnoIndex.sub_indexes:type_name -> mir.command.AssetAnnoIndex.SubIndexesEntry
	52, // 25: mir.command.MirTasks.tasks:type_name -> mir.command.MirTasks.TasksEntry
	2,  // 26: mir.command.Task.type:type_name -> mir.command.TaskType
	28, // 27: mir.command.Task.model:type_name -> mir.command.ModelMeta
	30, // 28: mir.command.Task.evaluation:type_name -> mir.command.Evaluation
	53, // 29: mir.command.Task.new_types:type_name -> mir.command.Task.NewTypesEntry
	54, // 30: mir.command.ModelMeta.stages:type_name -> mir.command.ModelMeta.StagesEntry
	31, // 31: mir.command.ModelMeta.evaluate_config:type_name -> mir.command.EvaluateConfig
	7,  // 32: mir.command.ModelMeta.object_type:type_name -> mir.command.ObjectType
	34, // 33: mir.command.ModelStage.ci_averaged_evaluation:type_name -> mir.command.SingleEvaluationElement
	31, // 34: mir.command.Evaluation.config:type_name -> mir.command.EvaluateConfig
	32, // 35: mir.command.Evaluation.dataset_evaluation:type_name -> mir.command.SingleDatasetEvaluation
	32, // 36: mir.command.Evaluation.main_ck:type_name -> mir.command.SingleDatasetEvaluation
	55, // 37: mir.command.Evaluation.sub_cks:type_name -> mir.command.Evaluation.SubCksEntry
	10, // 38: mir.command.Evaluation.state:type_name -> mir.command.EvaluationState
	56, // 39: mir.command.SingleDatasetEvaluation.iou_evaluations:type_name -> mir.command.SingleDatasetEvaluation.IouEvaluationsEntry
	33, // 40: mir.command.SingleDatasetEvaluation.iou_averaged_evaluation:type_name -> mir.command.SingleIouEvaluation
	57, // 41: mir.command.SingleIouEvaluation.ci_evaluations:type_name -> mir.command.SingleIouEvaluation.CiEvaluationsEntry
	34, // 42: mir.command.SingleIouEvaluation.ci_averaged_evaluation:type_name -> mir.command.SingleEvaluationElement
	36, // 43: mir.command.SingleEvaluationElement.pr_curve:type_name -> mir.command.FloatPoint
	58, // 44: mir.command.MirContext.cks_cnt:type_name -> mir.command.MirContext.CksCntEntry
	39, // 45: mir.command.MirContext.pred_stats:type_name -> mir.command.AnnoStats
	39, // 46: mir.command.MirContext.gt_stats:type_name -> mir.command.AnnoStats
	59, // 47: mir.command.SingleMapCount.sub_cnt:type_name -> mir.command.SingleMapCount.SubCntEntry
	60, // 48: mir.command.AnnoStats.tags_cnt:type_name -> mir.command.AnnoStats.TagsCntEntry
	61, // 49: mir.command.AnnoStats.class_ids_cnt:type_name -> mir.command.AnnoStats.ClassIdsCntEntry
	6,  // 50: mir.command.ExportConfig.asset_format:type_name -> mir.command.AssetFormat
	8,  // 51: mir.command.ExportConfig.anno_format:type_name -> mir.command.ExportFormat
	...
	25, // 55: mir.command.MirKeywords.CkIdxEntry.value:type_name -> mir.command.AssetAnnoIndex
	23, // 56: mir.command.CiTagToIndex.CisEntry.value:type_name -> mir.command.MapStringToInt32List
	25, // 57: mir.command.CiTagToIndex.TagsEntry.value:type_name -> mir.command.AssetAnnoIndex
	24, // 58: mir.command.MapStringToInt32List.KeyIdsEntry.value:type_name -> mir.command.Int32List
	24, // 59: mir.command.AssetAnnoIndex.AssetAnnosEntry.value:type_name -> mir.command.Int32List
	23, // 60: mir.command.AssetAnnoIndex.SubIndexesEntry.value:type_name -> mir.command.MapStringToInt32List
	27, // 61: mir.command.MirTasks.TasksEntry.value:type_name -> mir.command.Task
	29, // 62: mir.command.ModelMeta.StagesEntry.value:type_name -> mir.command.ModelStage
	32, // 63: mir.command.Evaluation.SubCksEntry.value:type_name -> mir.command.SingleDatasetEvaluation
	33, // 64: mir.command.SingleDatasetEvaluation.IouEvaluationsEntry.value:type_name -> mir.command.SingleIouEvaluation
	34, // 65: mir.command.SingleIouEvaluation.CiEvaluationsEntry.value:type_name -> mir.command.SingleEvaluationElement
	38, // 66: mir.command.MirContext.CksCntEntry.value:type_name -> mir.command.SingleMapCount
	38, // 67: mir.command.AnnoStats.TagsCntEntry.value:type_name -> mir.command.SingleMapCount
