...
var file_mir_command_proto_rawDesc = []byte{
	...
	0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x22, 0x51, 0x0a, 0x13, 0x53, 0x65, 0x67, 0x6d, 0x65,
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x6d, 0x49, 0x6f, 0x55, 0x22, 0xbb, 0x02, 0x0a, 0x13, 0x53,
...
var file_mir_command_proto_depIdxs = []int32{
	...
	59, // 41: mir.command.SingleIouEvaluation.ci_evaluations:type_name -> mir.command.SingleIouEvaluation.CiEvaluationsEntry
	36, // 42: mir.command.SingleIouEvaluation.ci_averaged_evaluation:type_name -> mir.command.SingleEvaluationElement
	38, // 43: mir.command.SingleEvaluationElement.pr_curve:type_name -> mir.command.FloatPoint
	60, // 44: mir.command.MirContext.cks_cnt:type_name -> mir.command.MirContext.CksCntEntry
	41, // 45: mir.command.MirContext.pred_stats:type_name -> mir.command.AnnoStats
	41, // 46: mir.command.MirContext.gt_stats:type_name -> mir.command.AnnoStats
	61, // 47: mir.command.SingleMapCount.sub_cnt:type_name -> mir.command.SingleMapCount.SubCntEntry
	62, // 48: mir.command.AnnoStats.tags_cnt:type_name -> mir.command.AnnoStats.TagsCntEntry
	63, // 49: mir.command.AnnoStats.class_ids_cnt:type_name -> mir.command.AnnoStats.ClassIdsCntEntry
	64, // 50: mir.command.AnnoStats.class_ids_mask_area:type_name -> mir.command.AnnoStats.ClassIdsMaskAreaEntry
	65, // 51: mir.command.AnnoStats.class_ids_obj_cnt:type_name -> mir.command.AnnoStats.ClassIdsObjCntEntry
	...
	35, // 66: mir.command.SingleDatasetEvaluation.IouEvaluationsEntry.value:type_name -> mir.command.SingleIouEvaluation
	36, // 67: mir.command.SingleIouEvaluation.CiEvaluationsEntry.value:type_name -> mir.command.SingleEvaluationElement
	40, // 68: mir.command.MirContext.CksCntEntry.value:type_name -> mir.command.SingleMapCount
	40, // 69: mir.command.AnnoStats.TagsCntEntry.value:type_name -> mir.command.SingleMapCount
