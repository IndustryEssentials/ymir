...
const (
	...
	RequestType_CMD_INSPECT_IMAGE   RequestType = 16
	...
	RequestType_TASK_SEQ_CREATE RequestType = 1002
)
...
type GeneralReq struct {
	...
	UserToken     string                   `protobuf:"bytes,29,opt,name=user_token,json=userToken,proto3" json:"user_token,omitempty"`
	ObjectType    ObjectType               `protobuf:"varint,30,opt,name=object_type,json=objectType,proto3,enum=mir.command.ObjectType" json:"object_type,omitempty"`
	...
	ReqCreateSeq  *ReqCreateSequentialTask `protobuf:"bytes,1002,opt,name=req_create_seq,json=reqCreateSeq,proto3" json:"req_create_seq,omitempty"`
}
...
func (x *GeneralReq) GetAnnotationType() AnnotationType {
	if x != nil {
		return x.AnnotationType
	}
	return AnnotationType_AT_NOT_SET
}

func (x *GeneralReq) GetUserToken() string {
	if x != nil {
		return x.UserToken
	}
	return ""
...
func (x *GeneralReq) GetObjectType() ObjectType {
	if x != nil {
		return x.ObjectType
	}
...
func (x *GeneralReq) GetReqCreateSeq() *ReqCreateSequentialTask {
	if x != nil {
		return x.ReqCreateSeq
	}
	return nil
}
...
type GeneralResp struct {
	...
	DockerImageConfig         map[int32]*Int32ToStringMap `protobuf:"bytes,12,rep,name=docker_image_config,json=dockerImageConfig,proto3" json:"docker_image_config,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Objects                   *RespCMDInference           `protobuf:"bytes,1000,opt,name=objects,proto3" json:"objects,omitempty"`
	DockerImageEnableLivecode bool                        `protobuf:"varint,1001,opt,name=docker_image_enable_livecode,json=dockerImageEnableLivecode,proto3" json:"docker_image_enable_livecode,omitempty"`
	Evaluation                *Evaluation                 `protobuf:"bytes,1002,opt,name=evaluation,proto3" json:"evaluation,omitempty"`
	DockerImageIsOfficial     bool                        `protobuf:"varint,1004,opt,name=docker_image_is_official,json=dockerImageIsOfficial,proto3" json:"docker_image_is_official,omitempty"`
}
...
func (x *GeneralResp) GetDockerImageConfig() map[int32]*Int32ToStringMap {
	if x != nil {
		return x.DockerImageConfig
	}
	return nil
...
func (x *GeneralResp) GetDockerImageEnableLivecode() bool {
	if x != nil {
		return x.DockerImageEnableLivecode
	}
	return false
}
...
func (x *GeneralResp) GetDockerImageIsOfficial() bool {
	if x != nil {
		return x.DockerImageIsOfficial
	}
	return false
}
...
func (x *ReqCreateSequentialTask) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqCreateSequentialTask) ProtoMessage() {}

func (x *ReqCreateSequentialTask) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReqCreateSequentialTask.ProtoReflect.Descriptor instead.
func (*ReqCreateSequentialTask) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{3}
}

func (x *ReqCreateSequentialTask) GetSeqId() string {
	if x != nil {
		return x.SeqId
	}
	return ""
...
func (x *ReqCreateSequentialTask) GetTasks() []*GeneralReq {
	if x != nil {
		return x.Tasks
	}
	return nil
...
func (x *ReqCreateSequentialTask) GetGpuCount() int32 {
	if x != nil {
		return x.GpuCount
	}
	return 0
...
type TaskReqMining struct {
	...
	// add or ignore
	UnknownTypesStrategy UnknownTypesStrategy `protobuf:"varint,3,opt,name=unknown_types_strategy,json=unknownTypesStrategy,proto3,enum=ymir.backend.UnknownTypesStrategy" json:"unknown_types_strategy,omitempty"`
}
...
func (x *TaskReqMining) GetUnknownTypesStrategy() UnknownTypesStrategy {
	if x != nil {
...
type TaskReqImportDataset struct {
	...
	AnnoFormat           AnnoFormat           `protobuf:"varint,8,opt,name=anno_format,json=annoFormat,proto3,enum=mir.command.AnnoFormat" json:"anno_format,omitempty"`
}
...
func (x *TaskReqImportDataset) GetAnnoFormat() AnnoFormat {
	if x != nil {
		return x.AnnoFormat
	}
...
type TaskReqLabeling struct {
	...
	AnnotationType       AnnotationType `protobuf:"varint,5,opt,name=annotation_type,json=annotationType,proto3,enum=mir.command.AnnotationType" json:"annotation_type,omitempty"`
}
...
type Int32ToStringMap struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Config map[int32]string `protobuf:"bytes,1,rep,name=config,proto3" json:"config,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *Int32ToStringMap) Reset() {
	*x = Int32ToStringMap{}
	if protoimpl.UnsafeEnabled {
...
func (x *Int32ToStringMap) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Int32ToStringMap) ProtoMessage() {}

func (x *Int32ToStringMap) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Int32ToStringMap.ProtoReflect.Descriptor instead.
func (*Int32ToStringMap) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{15}
}

func (x *Int32ToStringMap) GetConfig() map[int32]string {
	if x != nil {
		return x.Config
	}
	return nil
...
type HelTaskRequestImportDataset struct {
	...
	AnnoFormat           AnnoFormat           `protobuf:"varint,22,opt,name=anno_format,json=annoFormat,proto3,enum=mir.command.AnnoFormat" json:"anno_format,omitempty"`
...
func (x *HelTaskRequestImportDataset) GetAnnoFormat() AnnoFormat {
	if x != nil {
		return x.AnnoFormat
	}
	return AnnoFormat_AF_NO_ANNOS
...
func (x *HelTaskRequestExportDataset) GetAnnoFormat() AnnoFormat {
	if x != nil {
		return x.AnnoFormat
	}
	return AnnoFormat_AF_NO_ANNOS
...
var file_backend_proto_rawDesc = []byte{
	...
	0x22, 0xce, 0x0a, 0x0a, 0x0a, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x55, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x73, 0x53, 0x74, 0x72, 0x61,
	0x74, 0x65, 0x67, 0x79, 0x52, 0x14, 0x75, 0x6e, 0x6b, 0x6e, 0x6f, 0x77, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x73, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0xa4, 0x02, 0x0a, 0x14, 0x54,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x91, 0x01, 0x0a, 0x10, 0x49, 0x6e, 0x74, 0x33, 0x32, 0x54, 0x6f, 0x53, 0x74, 0x72, 0x69,
	0x6e, 0x67, 0x4d, 0x61, 0x70, 0x12, 0x42, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x79, 0x6d, 0x69, 0x72, 0x2e, 0x62, 0x61, 0x63,
	0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x49, 0x6e, 0x74, 0x33, 0x32, 0x54, 0x6f, 0x53, 0x74, 0x72, 0x69,
	0x6e, 0x67, 0x4d, 0x61, 0x70, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x45, 0x6e, 0x74, 0x72,
	...
	,
	...
	0x09, 0x63, 0x6c, 0x65, 0x61, 0x6e, 0x44, 0x69, 0x72, 0x73, 0x22, 0xa6, 0x01, 0x0a, 0x1b, 0x48,
	...
	,
	...
	0x72, 0x65, 0x70, 0x6f, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x6d, 0x69, 0x72, 0x2e,
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x54, 0x79, 0x70, 0x65,
	...
	,
	...
	,
...
var file_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_backend_proto_goTypes = []interface{}{
	...
	(HelOpsType)(0),                     // 3: ymir.backend.HelOpsType
	(*GeneralReq)(nil),                  // 4: ymir.backend.GeneralReq
	(*GeneralResp)(nil),                 // 5: ymir.backend.GeneralResp
	(*ReqCreateTask)(nil),               // 6: ymir.backend.ReqCreateTask
	(*ReqCreateSequentialTask)(nil),     // 7: ymir.backend.ReqCreateSequentialTask
	...
	(*Int32ToStringMap)(nil),            // 19: ymir.backend.Int32ToStringMap
	(*HelOpsRequest)(nil),               // 20: ymir.backend.HelOpsRequest
	(*HelOpsResponse)(nil),              // 21: ymir.backend.HelOpsResponse
	(*HelGpuInfo)(nil),                  // 22: ymir.backend.HelGpuInfo
	(*HelTaskRequestCopyDataset)(nil),   // 23: ymir.backend.HelTaskRequestCopyDataset
	(*HelTaskRequestImportDataset)(nil), // 24: ymir.backend.HelTaskRequestImportDataset
	(*HelTaskRequestExportDataset)(nil), // 25: ymir.backend.HelTaskRequestExportDataset
	(*HelTaskRequestImportModel)(nil),   // 26: ymir.backend.HelTaskRequestImportModel
	(*HelTaskRequestTrain)(nil),         // 27: ymir.backend.HelTaskRequestTrain
	(*HelTaskRequestMine)(nil),          // 28: ymir.backend.HelTaskRequestMine
	(*HelTaskRequestFuse)(nil),          // 29: ymir.backend.HelTaskRequestFuse
	(*HelTaskRequestPullImage)(nil),     // 30: ymir.backend.HelTaskRequestPullImage
	(*HelTaskRequest)(nil),              // 31: ymir.backend.HelTaskRequest
	(*HelTaskResponse)(nil),             // 32: ymir.backend.HelTaskResponse
	nil,                                 // 33: ymir.backend.GeneralResp.DockerImageConfigEntry
	nil,                                 // 34: ymir.backend.RespCMDInference.ImageAnnotationsEntry
	nil,                                 // 35: ymir.backend.Int32ToStringMap.ConfigEntry
	(TaskType)(0),                       // 36: mir.command.TaskType
	(*EvaluateConfig)(nil),              // 37: mir.command.EvaluateConfig
	(AnnotationType)(0),                 // 38: mir.command.AnnotationType
	(ObjectType)(0),                     // 39: mir.command.ObjectType
	(*Evaluation)(nil),                  // 40: mir.command.Evaluation
	(TvtType)(0),                        // 41: mir.command.TvtType
	(AnnoFormat)(0),                     // 42: mir.command.AnnoFormat
	(*SingleImageAnnotations)(nil),      // 43: mir.command.SingleImageAnnotations
}
var file_backend_proto_depIdxs = []int32{
	...
	36, // 2: ymir.backend.GeneralReq.terminated_task_type:type_name -> mir.command.TaskType
	17, // 3: ymir.backend.GeneralReq.label_collection:type_name -> ymir.backend.LabelCollection
	37, // 4: ymir.backend.GeneralReq.evaluate_config:type_name -> mir.command.EvaluateConfig
	38, // 5: ymir.backend.GeneralReq.annotation_type:type_name -> mir.command.AnnotationType
	39, // 6: ymir.backend.GeneralReq.object_type:type_name -> mir.command.ObjectType
	6,  // 7: ymir.backend.GeneralReq.req_create_task:type_name -> ymir.backend.ReqCreateTask
	7,  // 8: ymir.backend.GeneralReq.req_create_seq:type_name -> ymir.backend.ReqCreateSequentialTask
	17, // 9: ymir.backend.GeneralResp.label_collection:type_name -> ymir.backend.LabelCollection
	33, // 10: ymir.backend.GeneralResp.docker_image_config:type_name -> ymir.backend.GeneralResp.DockerImageConfigEntry
	16, // 11: ymir.backend.GeneralResp.objects:type_name -> ymir.backend.RespCMDInference
	40, // 12: ymir.backend.GeneralResp.evaluation:type_name -> mir.command.Evaluation
	36, // 13: ymir.backend.ReqCreateTask.task_type:type_name -> mir.command.TaskType
	9,  // 14: ymir.backend.ReqCreateTask.training:type_name -> ymir.backend.TaskReqTraining
	10, // 15: ymir.backend.ReqCreateTask.mining:type_name -> ymir.backend.TaskReqMining
	11, // 16: ymir.backend.ReqCreateTask.import_dataset:type_name -> ymir.backend.TaskReqImportDataset
	12, // 17: ymir.backend.ReqCreateTask.exporting:type_name -> ymir.backend.TaskReqExporting
	13, // 18: ymir.backend.ReqCreateTask.copy:type_name -> ymir.backend.TaskReqCopyData
	14, // 19: ymir.backend.ReqCreateTask.labeling:type_name -> ymir.backend.TaskReqLabeling
	15, // 20: ymir.backend.ReqCreateTask.import_model:type_name -> ymir.backend.TaskReqImportModel
	4,  // 21: ymir.backend.ReqCreateSequentialTask.tasks:type_name -> ymir.backend.GeneralReq
	41, // 22: ymir.backend.TrainingDatasetType.dataset_type:type_name -> mir.command.TvtType
	8,  // 23: ymir.backend.TaskReqTraining.in_dataset_types:type_name -> ymir.backend.TrainingDatasetType
	1,  // 24: ymir.backend.TaskReqMining.unknown_types_strategy:type_name -> ymir.backend.UnknownTypesStrategy
	1,  // 25: ymir.backend.TaskReqImportDataset.unknown_types_strategy:type_name -> ymir.backend.UnknownTypesStrategy
	42, // 26: ymir.backend.TaskReqImportDataset.anno_format:type_name -> mir.command.AnnoFormat
	42, // 27: ymir.backend.TaskReqExporting.format:type_name -> mir.command.AnnoFormat
	38, // 28: ymir.backend.TaskReqLabeling.annotation_type:type_name -> mir.command.AnnotationType
	34, // 29: ymir.backend.RespCMDInference.image_annotations:type_name -> ymir.backend.RespCMDInference.ImageAnnotationsEntry
	18, // 30: ymir.backend.LabelCollection.labels:type_name -> ymir.backend.Label
	35, // 31: ymir.backend.Int32ToStringMap.config:type_name -> ymir.backend.Int32ToStringMap.ConfigEntry
	3,  // 32: ymir.backend.HelOpsRequest.ops_type:type_name -> ymir.backend.HelOpsType
	36, // 33: ymir.backend.HelOpsRequest.term_task_type:type_name -> mir.command.TaskType
	22, // 34: ymir.backend.HelOpsResponse.gpu_info:type_name -> ymir.backend.HelGpuInfo
	20, // 35: ymir.backend.HelOpsResponse.request:type_name -> ymir.backend.HelOpsRequest
	42, // 36: ymir.backend.HelTaskRequestImportDataset.anno_format:type_name -> mir.command.AnnoFormat
	1,  // 37: ymir.backend.HelTaskRequestImportDataset.unknown_types_strategy:type_name -> ymir.backend.UnknownTypesStrategy
	42, // 38: ymir.backend.HelTaskRequestExportDataset.anno_format:type_name -> mir.command.AnnoFormat
	8,  // 39: ymir.backend.HelTaskRequestTrain.in_dataset_types:type_name -> ymir.backend.TrainingDatasetType
	0,  // 40: ymir.backend.HelTaskRequestTrain.merge_strategy:type_name -> ymir.backend.MergeStrategy
	0,  // 41: ymir.backend.HelTaskRequestFuse.merge_strategy:type_name -> ymir.backend.MergeStrategy
	36, // 42: ymir.backend.HelTaskRequest.task_type:type_name -> mir.command.TaskType
	29, // 43: ymir.backend.HelTaskRequest.fuse:type_name -> ymir.backend.HelTaskRequestFuse
	23, // 44: ymir.backend.HelTaskRequest.copy_dataset:type_name -> ymir.backend.HelTaskRequestCopyDataset
	24, // 45: ymir.backend.HelTaskRequest.import_dataset:type_name -> ymir.backend.HelTaskRequestImportDataset
	25, // 46: ymir.backend.HelTaskRequest.export_dataset:type_name -> ymir.backend.HelTaskRequestExportDataset
	26, // 47: ymir.backend.HelTaskRequest.import_model:type_name -> ymir.backend.HelTaskRequestImportModel
	30, // 48: ymir.backend.HelTaskRequest.pull_image:type_name -> ymir.backend.HelTaskRequestPullImage
	27, // 49: ymir.backend.HelTaskRequest.train:type_name -> ymir.backend.HelTaskRequestTrain
	28, // 50: ymir.backend.HelTaskRequest.mine:type_name -> ymir.backend.HelTaskRequestMine
	31, // 51: ymir.backend.HelTaskResponse.request:type_name -> ymir.backend.HelTaskRequest
	19, // 52: ymir.backend.GeneralResp.DockerImageConfigEntry.value:type_name -> ymir.backend.Int32ToStringMap
	43, // 53: ymir.backend.RespCMDInference.ImageAnnotationsEntry.value:type_name -> mir.command.SingleImageAnnotations
	4,  // 54: ymir.backend.mir_controller_service.data_manage_request:input_type -> ymir.backend.GeneralReq
	20, // 55: ymir.backend.hel_service.hel_ops_process:input_type -> ymir.backend.HelOpsRequest
	31, // 56: ymir.backend.hel_service.hel_task_process:input_type -> ymir.backend.HelTaskRequest
	5,  // 57: ymir.backend.mir_controller_service.data_manage_request:output_type -> ymir.backend.GeneralResp
	21, // 58: ymir.backend.hel_service.hel_ops_process:output_type -> ymir.backend.HelOpsResponse
	32, // 59: ymir.backend.hel_service.hel_task_process:output_type -> ymir.backend.HelTaskResponse
...
func file_backend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_backend_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReqCreateSequentialTask); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_backend_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
	...
	file_backend_proto_msgTypes[25].OneofWrappers = []interface{}{
