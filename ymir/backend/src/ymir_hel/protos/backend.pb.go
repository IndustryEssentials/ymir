...
type GeneralReq struct {
	...
	SequentialTasks []*ReqCreateTask      `protobuf:"bytes,1002,rep,name=sequential_tasks,json=sequentialTasks,proto3" json:"sequential_tasks,omitempty"`
}
...
func (x *GeneralReq) GetSequentialTasks() []*ReqCreateTask {
	if x != nil {
		return x.SequentialTasks
	}
	return nil
}
...
type GeneralResp struct {
	...
	SequentialTasksResp []*GeneralResp    `protobuf:"bytes,1004,rep,name=sequential_tasks_resp,json=sequentialTasksResp,proto3" json:"sequential_tasks_resp,omitempty"`
}
...
func (x *GeneralResp) GetSequentialTasksResp() []*GeneralResp {
	if x != nil {
		return x.SequentialTasksResp
	}
	return nil
}
...
type ReqCreateTask struct {
	...
	Fuse          *TaskReqFuse          `protobuf:"bytes,108,opt,name=fuse,proto3" json:"fuse,omitempty"`
}
...
func (x *ReqCreateTask) GetFuse() *TaskReqFuse {
	if x != nil {
		return x.Fuse
	}
	return nil
...
type TaskReqImportDataset struct {
	...
	ObjectType             ObjectType           `protobuf:"varint,6,opt,name=object_type,json=objectType,proto3,enum=mir.command.ObjectType" json:"object_type,omitempty"`
...
func (x *TaskReqImportDataset) GetObjectType() ObjectType {
	if x != nil {
		return x.ObjectType
	}
	return ObjectType_OT_UNKNOWN
...
type TaskReqFuse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	InDatasetIds []string `protobuf:"bytes,1,rep,name=in_dataset_ids,json=inDatasetIds,proto3" json:"in_dataset_ids,omitempty"`
	ExDatasetIds []string `protobuf:"bytes,2,rep,name=ex_dataset_ids,json=exDatasetIds,proto3" json:"ex_dataset_ids,omitempty"`
	InClassIds   []int32  `protobuf:"varint,11,rep,packed,name=in_class_ids,json=inClassIds,proto3" json:"in_class_ids,omitempty"`
	ExClassIds   []int32  `protobuf:"varint,12,rep,packed,name=ex_class_ids,json=exClassIds,proto3" json:"ex_class_ids,omitempty"`
	// Types that are assignable to Sampling:
	//	*TaskReqFuse_SamplingCount
	//	*TaskReqFuse_SamplingRate
	Sampling isTaskReqFuse_Sampling `protobuf_oneof:"sampling"`
}

func (x *TaskReqFuse) Reset() {
	*x = TaskReqFuse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TaskReqFuse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TaskReqFuse) ProtoMessage() {}

func (x *TaskReqFuse) ProtoReflect() protoreflect.Message {
	mi := &file_backend_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TaskReqFuse.ProtoReflect.Descriptor instead.
func (*TaskReqFuse) Descriptor() ([]byte, []int) {
	return file_backend_proto_rawDescGZIP(), []int{9}
}

func (x *TaskReqFuse) GetInDatasetIds() []string {
	if x != nil {
		return x.InDatasetIds
	}
	return nil
...
func (x *TaskReqFuse) GetExDatasetIds() []string {
	if x != nil {
		return x.ExDatasetIds
	}
	return nil
...
func (x *TaskReqFuse) GetInClassIds() []int32 {
	if x != nil {
		return x.InClassIds
	}
	return nil
...
func (x *TaskReqFuse) GetExClassIds() []int32 {
	if x != nil {
		return x.ExClassIds
	}
	return nil
...
func (m *TaskReqFuse) GetSampling() isTaskReqFuse_Sampling {
	if m != nil {
		return m.Sampling
	}
	return nil
...
func (x *TaskReqFuse) GetSamplingCount() int32 {
	if x, ok := x.GetSampling().(*TaskReqFuse_SamplingCount); ok {
		return x.SamplingCount
	}
	return 0
}

func (x *TaskReqFuse) GetSamplingRate() float32 {
	if x, ok := x.GetSampling().(*TaskReqFuse_SamplingRate); ok {
		return x.SamplingRate
	}
	return 0
}

type isTaskReqFuse_Sampling interface {
	isTaskReqFuse_Sampling()
}

type TaskReqFuse_SamplingCount struct {
	SamplingCount int32 `protobuf:"varint,21,opt,name=sampling_count,json=samplingCount,proto3,oneof"`
}

type TaskReqFuse_SamplingRate struct {
	SamplingRate float32 `protobuf:"fixed32,22,opt,name=sampling_rate,json=samplingRate,proto3,oneof"`
}

func (*TaskReqFuse_SamplingCount) isTaskReqFuse_Sampling() {}

func (*TaskReqFuse_SamplingRate) isTaskReqFuse_Sampling() {}
...
func (x *TaskReqLabeling) GetObjectType() ObjectType {
	if x != nil {
		return x.ObjectType
	}
	return ObjectType_OT_UNKNOWN
...
var file_backend_proto_rawDesc = []byte{
	...
	0x22, 0xaa, 0x09, 0x0a, 0x0a, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x71, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x12, 0x38, 0x0a, 0x18, 0x69, 0x73, 0x5f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65,
	0x5f, 0x73, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x16, 0x69, 0x73, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x53,
	0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xb3, 0x01, 0x0a, 0x10,
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x44, 0x69, 0x72, 0x12,
	0x19, 0x0a, 0x08, 0x70, 0x72, 0x65, 0x64, 0x5f, 0x64, 0x69, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x70, 0x72, 0x65, 0x64, 0x44, 0x69, 0x72, 0x12, 0x15, 0x0a, 0x06, 0x67, 0x74,
	0x5f, 0x64, 0x69, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x67, 0x74, 0x44, 0x69,
	0x72, 0x22, 0xae, 0x01, 0x0a, 0x0f, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x43, 0x6f, 0x70,
	0x79, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1e, 0x0a, 0x0b, 0x73, 0x72, 0x63, 0x5f, 0x75, 0x73, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0xa4, 0x01, 0x0a, 0x0d, 0x48, 0x65, 0x6c, 0x4f, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	0x07, 0x55, 0x54, 0x53, 0x5f, 0x41, 0x44, 0x44, 0x10, 0x02, 0x2a, 0x9e, 0x04, 0x0a, 0x0b, 0x52,
	...
	0x41, 0x54, 0x45, 0x10, 0x0e, 0x12, 0x12, 0x0a, 0x0e, 0x43, 0x4d, 0x44, 0x5f, 0x50, 0x55, 0x4c,
	0x4c, 0x5f, 0x49, 0x4d, 0x41, 0x47, 0x45, 0x10, 0x10, 0x12, 0x14, 0x0a, 0x10, 0x43, 0x4d, 0x44,
	...
	0x54, 0x45, 0x10, 0xe9, 0x07, 0x22, 0x04, 0x08, 0x0f, 0x10, 0x0f, 0x2a, 0x2f, 0x0a, 0x0e, 0x41,
	0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a,
	0x07, 0x4e, 0x4f, 0x54, 0x5f, 0x53, 0x45, 0x54, 0x10, 0x00, 0x12, 0x06, 0x0a, 0x02, 0x47, 0x54,
	0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x50, 0x52, 0x45, 0x44, 0x10, 0x02, 0x2a, 0x4d, 0x0a, 0x0a,
...
var file_backend_proto_goTypes = []interface{}{
	...
	(*TaskReqFuse)(nil),                 // 14: ymir.backend.TaskReqFuse
	(*TaskReqLabeling)(nil),             // 15: ymir.backend.TaskReqLabeling
	(*TaskReqImportModel)(nil),          // 16: ymir.backend.TaskReqImportModel
	(*RespCMDInference)(nil),            // 17: ymir.backend.RespCMDInference
	(*LabelCollection)(nil),             // 18: ymir.backend.LabelCollection
	(*Label)(nil),                       // 19: ymir.backend.Label
	...
	(TaskType)(0),                       // 35: mir.command.TaskType
	(*EvaluateConfig)(nil),              // 36: mir.command.EvaluateConfig
	(*Evaluation)(nil),                  // 37: mir.command.Evaluation
	(ObjectType)(0),                     // 38: mir.command.ObjectType
	(TvtType)(0),                        // 39: mir.command.TvtType
	(ExportFormat)(0),                   // 40: mir.command.ExportFormat
	(*SingleImageAnnotations)(nil),      // 41: mir.command.SingleImageAnnotations
}
var file_backend_proto_depIdxs = []int32{
	...
	35, // 2: ymir.backend.GeneralReq.terminated_task_type:type_name -> mir.command.TaskType
	18, // 3: ymir.backend.GeneralReq.label_collection:type_name -> ymir.backend.LabelCollection
	36, // 4: ymir.backend.GeneralReq.evaluate_config:type_name -> mir.command.EvaluateConfig
	7,  // 5: ymir.backend.GeneralReq.req_create_task:type_name -> ymir.backend.ReqCreateTask
	7,  // 6: ymir.backend.GeneralReq.sequential_tasks:type_name -> ymir.backend.ReqCreateTask
	33, // 7: ymir.backend.GeneralResp.docker_image_config:type_name -> ymir.backend.GeneralResp.DockerImageConfigEntry
	18, // 8: ymir.backend.GeneralResp.label_collection:type_name -> ymir.backend.LabelCollection
	17, // 9: ymir.backend.GeneralResp.objects:type_name -> ymir.backend.RespCMDInference
	37, // 10: ymir.backend.GeneralResp.evaluation:type_name -> mir.command.Evaluation
	38, // 11: ymir.backend.GeneralResp.object_type:type_name -> mir.command.ObjectType
	6,  // 12: ymir.backend.GeneralResp.sequential_tasks_resp:type_name -> ymir.backend.GeneralResp
	35, // 13: ymir.backend.ReqCreateTask.task_type:type_name -> mir.command.TaskType
	...
	15, // 19: ymir.backend.ReqCreateTask.labeling:type_name -> ymir.backend.TaskReqLabeling
	16, // 20: ymir.backend.ReqCreateTask.import_model:type_name -> ymir.backend.TaskReqImportModel
	14, // 21: ymir.backend.ReqCreateTask.fuse:type_name -> ymir.backend.TaskReqFuse
	39, // 22: ymir.backend.TrainingDatasetType.dataset_type:type_name -> mir.command.TvtType
	...
	38, // 25: ymir.backend.TaskReqImportDataset.object_type:type_name -> mir.command.ObjectType
	40, // 26: ymir.backend.TaskReqExporting.format:type_name -> mir.command.ExportFormat
	3,  // 27: ymir.backend.TaskReqLabeling.annotation_type:type_name -> ymir.backend.AnnotationType
	38, // 28: ymir.backend.TaskReqLabeling.object_type:type_name -> mir.command.ObjectType
	34, // 29: ymir.backend.RespCMDInference.image_annotations:type_name -> ymir.backend.RespCMDInference.ImageAnnotationsEntry
	19, // 30: ymir.backend.LabelCollection.labels:type_name -> ymir.backend.Label
	4,  // 31: ymir.backend.HelOpsRequest.ops_type:type_name -> ymir.backend.HelOpsType
	35, // 32: ymir.backend.HelOpsRequest.term_task_type:type_name -> mir.command.TaskType
	...
	40, // 35: ymir.backend.HelTaskRequestImportDataset.anno_format:type_name -> mir.command.ExportFormat
	1,  // 36: ymir.backend.HelTaskRequestImportDataset.unknown_types_strategy:type_name -> ymir.backend.UnknownTypesStrategy
	40, // 37: ymir.backend.HelTaskRequestExportDataset.anno_format:type_name -> mir.command.ExportFormat
	...
	35, // 41: ymir.backend.HelTaskRequest.task_type:type_name -> mir.command.TaskType
	...
	41, // 51: ymir.backend.RespCMDInference.ImageAnnotationsEntry.value:type_name -> mir.command.SingleImageAnnotations
	5,  // 52: ymir.backend.mir_controller_service.data_manage_request:input_type -> ymir.backend.GeneralReq
	...
	6,  // 55: ymir.backend.mir_controller_service.data_manage_request:output_type -> ymir.backend.GeneralResp
...
func file_backend_proto_init() {
	...
	file_backend_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*TaskReqFuse_SamplingCount)(nil),
		(*TaskReqFuse_SamplingRate)(nil),
	}
	file_backend_proto_msgTypes[24].OneofWrappers = []interface{}{
