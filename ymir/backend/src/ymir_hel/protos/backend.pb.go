...
var file_backend_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x2a,
	...
	0x45, 0x44, 0x10, 0x02, 0x32, 0x66, 0x0a, 0x16, 0x6d, 0x69, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x74,
	...
	0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07,
...
var file_backend_proto_goTypes = []interface{}{
	...
	(*TaskReqTraining)(nil),                     // 7: ymir.backend.TaskReqTraining
	(*TaskReqMining)(nil),                       // 8: ymir.backend.TaskReqMining
	(*TaskReqImportDataset)(nil),                // 9: ymir.backend.TaskReqImportDataset
	(*TaskReqExporting)(nil),                    // 10: ymir.backend.TaskReqExporting
	(*TaskReqCopyData)(nil),                     // 11: ymir.backend.TaskReqCopyData
	(*TaskReqLabeling)(nil),                     // 12: ymir.backend.TaskReqLabeling
	(*TaskReqImportModel)(nil),                  // 13: ymir.backend.TaskReqImportModel
	(*RespCMDInference)(nil),                    // 14: ymir.backend.RespCMDInference
	(*LabelCollection)(nil),                     // 15: ymir.backend.LabelCollection
	(*Label)(nil),                               // 16: ymir.backend.Label
	nil,                                         // 17: ymir.backend.GeneralResp.DockerImageConfigEntry
	(*TaskReqTraining_TrainingDatasetType)(nil), // 18: ymir.backend.TaskReqTraining.TrainingDatasetType
	nil,                            // 19: ymir.backend.RespCMDInference.ImageAnnotationsEntry
	(TaskType)(0),                  // 20: mir.command.TaskType
	(*EvaluateConfig)(nil),         // 21: mir.command.EvaluateConfig
	(*Evaluation)(nil),             // 22: mir.command.Evaluation
	(AnnoFormat)(0),                // 23: mir.command.AnnoFormat
	(TvtType)(0),                   // 24: mir.command.TvtType
	(*SingleImageAnnotations)(nil), // 25: mir.command.SingleImageAnnotations
}
var file_backend_proto_depIdxs = []int32{
	...
	20, // 2: ymir.backend.GeneralReq.terminated_task_type:type_name -> mir.command.TaskType
	15, // 3: ymir.backend.GeneralReq.label_collection:type_name -> ymir.backend.LabelCollection
	21, // 4: ymir.backend.GeneralReq.evaluate_config:type_name -> mir.command.EvaluateConfig
	6,  // 5: ymir.backend.GeneralReq.req_create_task:type_name -> ymir.backend.ReqCreateTask
	17, // 6: ymir.backend.GeneralResp.docker_image_config:type_name -> ymir.backend.GeneralResp.DockerImageConfigEntry
	15, // 7: ymir.backend.GeneralResp.label_collection:type_name -> ymir.backend.LabelCollection
	14, // 8: ymir.backend.GeneralResp.detection:type_name -> ymir.backend.RespCMDInference
	22, // 9: ymir.backend.GeneralResp.evaluation:type_name -> mir.command.Evaluation
	20, // 10: ymir.backend.ReqCreateTask.task_type:type_name -> mir.command.TaskType
	7,  // 11: ymir.backend.ReqCreateTask.training:type_name -> ymir.backend.TaskReqTraining
	8,  // 12: ymir.backend.ReqCreateTask.mining:type_name -> ymir.backend.TaskReqMining
	9,  // 13: ymir.backend.ReqCreateTask.import_dataset:type_name -> ymir.backend.TaskReqImportDataset
	10, // 14: ymir.backend.ReqCreateTask.exporting:type_name -> ymir.backend.TaskReqExporting
	11, // 15: ymir.backend.ReqCreateTask.copy:type_name -> ymir.backend.TaskReqCopyData
	12, // 16: ymir.backend.ReqCreateTask.labeling:type_name -> ymir.backend.TaskReqLabeling
	13, // 17: ymir.backend.ReqCreateTask.import_model:type_name -> ymir.backend.TaskReqImportModel
	18, // 18: ymir.backend.TaskReqTraining.in_dataset_types:type_name -> ymir.backend.TaskReqTraining.TrainingDatasetType
	1,  // 19: ymir.backend.TaskReqImportDataset.unknown_types_strategy:type_name -> ymir.backend.UnknownTypesStrategy
	23, // 20: ymir.backend.TaskReqExporting.format:type_name -> mir.command.AnnoFormat
	3,  // 21: ymir.backend.TaskReqLabeling.annotation_type:type_name -> ymir.backend.AnnotationType
	19, // 22: ymir.backend.RespCMDInference.image_annotations:type_name -> ymir.backend.RespCMDInference.ImageAnnotationsEntry
	16, // 23: ymir.backend.LabelCollection.labels:type_name -> ymir.backend.Label
	24, // 24: ymir.backend.TaskReqTraining.TrainingDatasetType.dataset_type:type_name -> mir.command.TvtType
	25, // 25: ymir.backend.RespCMDInference.ImageAnnotationsEntry.value:type_name -> mir.command.SingleImageAnnotations
	4,  // 26: ymir.backend.mir_controller_service.data_manage_request:input_type -> ymir.backend.GeneralReq
	5,  // 27: ymir.backend.mir_controller_service.data_manage_request:output_type -> ymir.backend.GeneralResp
