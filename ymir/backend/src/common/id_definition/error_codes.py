...
class CTLResponseCode(IntEnum):
    ...
    INVOKER_VISUALIZATION_TASK_NETWORK_ERROR = 130607
    INVOKER_VISUALIZATION_TASK_FIFTYONE_ERROR = 130608
...
class UpdateErrorCode(IntEnum):
    ...
    MULTIPLE_USER_SPACE_VERSIONS = 170003
    BACKUP_DIR_NOT_EMPTY = 170004
    SANDBOX_VERSION_NOT_SUPPORTED = 170005
    ENV_VERSION_NOT_MATCH = 170006
