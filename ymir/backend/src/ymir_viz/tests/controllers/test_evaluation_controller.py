...
from mir.tools import det_eval_ctl_ops
...
class TestEvaluationController:
    def test_dataset_fast_evaluate(self, test_client: Any, mocker: plugin.MockerFixture) -> None:
        ...
        mocker.patch.object(det_eval_ctl_ops, 'det_evaluate_datasets', return_value=evaluation)
        ...
        assert resp.json()['result'] == evaluation_json['dataset_evaluation']
