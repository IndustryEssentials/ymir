...
var file_mir_command_proto_rawDesc = []byte{
	...
	0x6d, 0x41, 0x50, 0x22, 0xfa, 0x02, 0x0a, 0x0a, 0x45, 0x76, 0x61, 0x6c, 0x75, 0x61, 0x74, 0x69,
	...
	0x79, 0x52, 0x06, 0x73, 0x75, 0x62, 0x43, 0x6b, 0x73, 0x1a, 0x5f, 0x0a, 0x0b, 0x53, 0x75, 0x62,
	0x43, 0x6b, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18,
	...
	0x45, 0x44, 0x10, 0x0c, 0x42, 0x09, 0x5a, 0x07, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x62,
...
var file_mir_command_proto_goTypes = []interface{}{
	...
	nil,                             // 43: mir.command.SingleTaskAnnotations.MapIdColorEntry
...
var file_mir_command_proto_depIdxs = []int32{
	...
	43, // 9: mir.command.SingleTaskAnnotations.map_id_color:type_name -> mir.command.SingleTaskAnnotations.MapIdColorEntry
	28, // 10: mir.command.SingleTaskAnnotations.model:type_name -> mir.command.ModelMeta
	18, // 11: mir.command.SingleImageAnnotations.boxes:type_name -> mir.command.ObjectAnnotation
	18, // 12: mir.command.SingleImageAnnotations.polygons:type_name -> mir.command.ObjectAnnotation
	17, // 13: mir.command.SingleImageAnnotations.mask:type_name -> mir.command.MaskAnnotation
	44, // 14: mir.command.SingleImageCks.cks:type_name -> mir.command.SingleImageCks.CksEntry
	19, // 15: mir.command.ObjectAnnotation.box:type_name -> mir.command.Rect
	45, // 16: mir.command.ObjectAnnotation.tags:type_name -> mir.command.ObjectAnnotation.TagsEntry
	9,  // 17: mir.command.ObjectAnnotation.cm:type_name -> mir.command.ConfusionMatrixType
	35, // 18: mir.command.ObjectAnnotation.polygon:type_name -> mir.command.IntPoint
	21, // 19: mir.command.MirKeywords.pred_idx:type_name -> mir.command.CiTagToIndex
	21, // 20: mir.command.MirKeywords.gt_idx:type_name -> mir.command.CiTagToIndex
	46, // 21: mir.command.MirKeywords.ck_idx:type_name -> mir.command.MirKeywords.CkIdxEntry
	47, // 22: mir.command.CiTagToIndex.cis:type_name -> mir.command.CiTagToIndex.CisEntry
	48, // 23: mir.command.CiTagToIndex.tags:type_name -> mir.command.CiTagToIndex.TagsEntry
	49, // 24: mir.command.MapStringToInt32List.key_ids:type_name -> mir.command.MapStringToInt32List.KeyIdsEntry
	50, // 25: mir.command.AssetAnnoIndex.asset_annos:type_name -> mir.command.AssetAnnoIndex.AssetAnnosEntry
	51, // 26: mir.command.AssetAnnoIndex.sub_indexes:type_name -> mir.command.AssetAnnoIndex.SubIndexesEntry
	52, // 27: mir.command.MirTasks.tasks:type_name -> mir.command.MirTasks.TasksEntry
	2,  // 28: mir.command.Task.type:type_name -> mir.command.TaskType
	28, // 29: mir.command.Task.model:type_name -> mir.command.ModelMeta
	30, // 30: mir.command.Task.evaluation:type_name -> mir.command.Evaluation
	53, // 31: mir.command.Task.new_types:type_name -> mir.command.Task.NewTypesEntry
	54, // 32: mir.command.ModelMeta.stages:type_name -> mir.command.ModelMeta.StagesEntry
	...
	56, // 37: mir.command.SingleDatasetEvaluation.iou_evaluations:type_name -> mir.command.SingleDatasetEvaluation.IouEvaluationsEntry
	33, // 38: mir.command.SingleDatasetEvaluation.iou_averaged_evaluation:type_name -> mir.command.SingleIouEvaluation
	57, // 39: mir.command.SingleIouEvaluation.ci_evaluations:type_name -> mir.command.SingleIouEvaluation.CiEvaluationsEntry
	34, // 40: mir.command.SingleIouEvaluation.ci_averaged_evaluation:type_name -> mir.command.SingleEvaluationElement
	36, // 41: mir.command.SingleEvaluationElement.pr_curve:type_name -> mir.command.FloatPoint
	58, // 42: mir.command.MirContext.cks_cnt:type_name -> mir.command.MirContext.CksCntEntry
	39, // 43: mir.command.MirContext.pred_stats:type_name -> mir.command.AnnoStats
	39, // 44: mir.command.MirContext.gt_stats:type_name -> mir.command.AnnoStats
	59, // 45: mir.command.SingleMapCount.sub_cnt:type_name -> mir.command.SingleMapCount.SubCntEntry
	60, // 46: mir.command.AnnoStats.tags_cnt:type_name -> mir.command.AnnoStats.TagsCntEntry
	61, // 47: mir.command.AnnoStats.class_ids_cnt:type_name -> mir.command.AnnoStats.ClassIdsCntEntry
	11, // 48: mir.command.MirMetadatas.AttributesEntry.value:type_name -> mir.command.MetadataAttributes
	16, // 49: mir.command.MirAnnotations.ImageCksEntry.value:type_name -> mir.command.SingleImageCks
	15, // 50: mir.command.SingleTaskAnnotations.ImageAnnotationsEntry.value:type_name -> mir.command.SingleImageAnnotations
	35, // 51: mir.command.SingleTaskAnnotations.MapIdColorEntry.value:type_name -> mir.command.IntPoint
	25, // 52: mir.command.MirKeywords.CkIdxEntry.value:type_name -> mir.command.AssetAnnoIndex
	23, // 53: mir.command.CiTagToIndex.CisEntry.value:type_name -> mir.command.MapStringToInt32List
	25, // 54: mir.command.CiTagToIndex.TagsEntry.value:type_name -> mir.command.AssetAnnoIndex
	24, // 55: mir.command.MapStringToInt32List.KeyIdsEntry.value:type_name -> mir.command.Int32List
	24, // 56: mir.command.AssetAnnoIndex.AssetAnnosEntry.value:type_name -> mir.command.Int32List
	23, // 57: mir.command.AssetAnnoIndex.SubIndexesEntry.value:type_name -> mir.command.MapStringToInt32List
	27, // 58: mir.command.MirTasks.TasksEntry.value:type_name -> mir.command.Task
	29, // 59: mir.command.ModelMeta.StagesEntry.value:type_name -> mir.command.ModelStage
	32, // 60: mir.command.Evaluation.SubCksEntry.value:type_name -> mir.command.SingleDatasetEvaluation
	33, // 61: mir.command.SingleDatasetEvaluation.IouEvaluationsEntry.value:type_name -> mir.command.SingleIouEvaluation
	34, // 62: mir.command.SingleIouEvaluation.CiEvaluationsEntry.value:type_name -> mir.command.SingleEvaluationElement
	38, // 63: mir.command.MirContext.CksCntEntry.value:type_name -> mir.command.SingleMapCount
	38, // 64: mir.command.AnnoStats.TagsCntEntry.value:type_name -> mir.command.SingleMapCount
