...
from common_utils.version import YMIR_PB_VERSION, ymir_salient_version
...
def check_mir_repo_version() -> None:
    ...
    if ymir_salient_version(sandbox_versions[0]) != ymir_salient_version(YMIR_PB_VERSION):
        raise ValueError(f"mismatched salient version: {sandbox_versions[0]} vs {YMIR_PB_VERSION}.")
