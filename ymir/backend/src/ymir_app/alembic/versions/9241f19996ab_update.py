...
def upgrade():
    ...
    op.create_table('docker_image_config',
    ...
    op.create_table('docker_image_relationship',
    ...
    op.create_index(op.f('ix_docker_image_relationship_dest_image_id'), 'docker_image_relationship', ['dest_image_id'], unique=False)
    op.create_index(op.f('ix_docker_image_relationship_src_image_id'), 'docker_image_relationship', ['src_image_id'], unique=False)
    ...
    op.create_index(op.f('ix_project_training_dataset_group_id'), 'project', ['training_dataset_group_id'], unique=False)
