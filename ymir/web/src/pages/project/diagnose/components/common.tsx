import { Model, Prediction } from '@/constants'
...
export function getModelCell(prediction: Prediction, models: Model[], text?: string) {
...
export const opt = (d: { id: number; name: string }) => ({ value: d.id, label: d.name })
