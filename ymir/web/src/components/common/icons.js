...
export const Start = iconFont('start')
export const Stop = iconFont('stop')
export const Bell = iconFont('bell')
export const Wait = iconFont('wait')
export const Tipts = iconFont('tipts')
export const Diagnosis2 = iconFont('diagnosis2')
export const GovernmentLine = iconFont('government-line')
export const Diagnosis = iconFont('diagnosis')
export const Scene = iconFont('scene')
