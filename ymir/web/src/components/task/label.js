...
function Label({
  ...
  function docChange(files, docFile) {
    setDoc(
      files.length ? location.protocol + "//" + location.host + docFile : ""
    )
  }
      ...
      >
        <div hidden={hidden}>
            ...
            >
              <Row gutter={20}>
                <Col flex={1}>
                  ...
                  >
                    <Input
                      placeholder={t("task.label.form.member.placeholder")}
                      allowClear
                    />
                  </Form.Item>
                </Col>
                <Col style={{ lineHeight: "30px" }}>
                  <Checkbox
                    checked={asChecker}
                    onChange={({ target }) => setAsChecker(target.checked)}
                  >
          ...
          <Form.Item
            ...
            label={t("task.label.form.plat.label")}
            required
          >
            <Row gutter={20}>
              <Col flex={1}>
                ...
                >
                  <Input
                    placeholder={t("task.label.form.member.labelplatacc")}
                    allowClear
                  />
                </Form.Item>
              </Col>
