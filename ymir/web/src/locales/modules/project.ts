const project = {
  ...
  'project.prepare.trainset': { en: 'Candidate Training Set', cn: '训练集准备', },
  'project.prepare.validationset': { en: 'Validation Set', cn: '验证集准备', },
  'project.prepare.miningset': { en: 'Mining Set', cn: '挖掘集准备', },
  'project.prepare.model': { en: 'Initial Model', cn: '初始模型准备', },
