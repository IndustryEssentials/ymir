const project = {
  ...
  'project.del.confirm.content': { en: '删除项目会将项目中的所有资源（数据集、模型）删除，请谨慎操作！', 
    cn: 'Delete project will remove all datasets and models in project, please delete after careful consideration!', },
}
