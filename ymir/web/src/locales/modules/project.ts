const project = {
  ...
  'project.prepare.trainset': { en: 'Re-process', cn: '训练集准备', },
  'project.prepare.validationset': { en: 'Re-process', cn: '测试集准备', },
  'project.prepare.miningset': { en: 'Re-process', cn: '挖掘集准备', },
  'project.prepare.model': { en: 'Re-process', cn: '初始模型准备', },
