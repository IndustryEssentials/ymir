const dataset = {
  ...
  'dataset.filter.validate.inputs': { cn: '请输入至少一项筛选条件', en: 'Please input at less one condition for filter', },
  'dataset.merge.validate.inputs': { cn: '请输入至少一项合并条件', en: 'Please input at less one condition for merge', },
