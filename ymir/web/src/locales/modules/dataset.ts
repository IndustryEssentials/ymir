const dataset = {
  ...
  'dataset.analysis.unit.crowdedness': { cn: '标注框数', en: 'Bounding Boxes' },
  'dataset.analysis.unit.complexity': { cn: '类别数', en: 'Classes Count' },
  ...
  'dataset.analysis.suggestion.annotationCount': {
    cn: '建议增加包含{values}类别的图像，使各类别的标注数量到达{bounding}+。',
    en: 'It is suggested to add more images containing {values}, in order to reach a minimum annotation count of {bounding} for each class',
  },
