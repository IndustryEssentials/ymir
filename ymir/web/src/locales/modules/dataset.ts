const dataset = {
  ...
  "dataset.type.train": { cn: "训练", en: "Train Model", },
  "dataset.type.mine": { cn: "挖掘", en: "Mining Data", },
  "dataset.type.label": { cn: "标注", en: "Label Data", },
  "dataset.type.fusion": { cn: "预处理", en: "Pretreat", },
  ...
  "dataset.add.success.msg": { cn: "导入任务创建成功", en: "Import dataset task created", },
