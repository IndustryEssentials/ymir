const dataset = {
  ...
  "dataset.type.train": { cn: "训练模型", en: "Train Model", },
  "dataset.type.mine": { cn: "挖掘数据", en: "Mining Data", },
  "dataset.type.label": { cn: "数据标注", en: "Label Data", },
  "dataset.type.filter": { cn: "筛选标签", en: "Filter Label", },
  ...
  "dataset.add.form.label.label": { cn: "标注状态", en: "Type", },
  ...
  "dataset.add.form.newkw.link": { cn: "前往标签列表添加>>", en: "Add New Keywords>>", },
  "dataset.add.form.newkw.tip": { cn: "当导入数据集中包含的标签不属于当前标签列表时，选择标签合并策略", 
  en: "Select keyword merging strategy for new keywords", },
  "dataset.add.label_strategy.include": { cn: "包含标注信息", en: "Include Annotations", },
  "dataset.add.label_strategy.exclude": { cn: "不包含标注信息", en: "Exclude Annotations", },
  ...
  'dataset.detail.action.filter': { cn: '筛选标签', en: 'Filter Label', },
