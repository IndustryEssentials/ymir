const errors = {
  'error500': { cn: '内部服务错误，请重试或联系管理员', en: 'Service Error, please retry or contact admin', },
  'error504': { cn: '网关请求超时，后端服务异常', en: 'Gateway Timeout, backend service expection', },
  'error502': { cn: '网关异常，无法连接到后端服务', en: 'Bad Gateway, backend service disconnect', },
  ...
  'error130700': { cn: '用户工程路径不可用', en: 'Invalid user project path', },
  ...
  'error180001': { cn: '容器: 配置文件错误', en: 'Container: Config file error', },
  'error180002': { cn: '容器: 训练集或测试集错误', en: 'Container: Training / Validation dataset error', },
  'error180003': { cn: '容器: 图片格式错误', en: 'Container: Unknown image format', },
  'error180004': { cn: '容器: 模型错误', en: 'Container: Model error', },
  'error180101': { cn: '容器: CUDA 与 GPU 不兼容', en: 'Container: CUDA and GPU mismatch', },
  'error180102': { cn: '容器: 未找到 GPU', en: 'Container: No GPU', },
  'error180103': { cn: '容器: 内存或显存不足', en: 'Container: Out Of Memory', },
  'error180201': { cn: '容器: NaN 错误', en: 'Container: NaN error', },
  'error180301': { cn: '容器: 网络错误', en: 'Container: Network error', },
