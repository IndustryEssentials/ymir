const errors = {
  ...
  'error110903': { cn: '验证失败，未推理出图片上相应的类别', en: 'Verification failed, none of annotations for related classes been infered.', },
  ...
  'error160016': { cn: 'CMD: 数据集解析失败或不可用', en: 'Dataset parse failed or invalid', },
  ...
  'error300201': { cn: '容器: NaN 错误', en: 'Container: NaN error', },
  'error300301': { cn: '容器: 网络错误', en: 'Container: Network error', },
