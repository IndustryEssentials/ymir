const model = {
  ...
  "model.diagnose.analysis.column.box_count": { cn: "标注框总数", en: "Boxes Count", },
  "model.diagnose.analysis.column.average_labels": { cn: "平均标注数", en: "Average Of Labels", },
  "model.diagnose.analysis.column.overall": { cn: "总标注情况", en: "Overall Labeling", },
  "model.diagnose.analysis.param.title": { cn: "选择", en: "Select", },
  "model.diagnose.analysis.param.dataset": { cn: "数据集", en: "Dataset", },
  ...
  "model.diagnose.analysis.title.keyword_ratio": { cn: "标签占比", en: "Keyword Ratio", },
