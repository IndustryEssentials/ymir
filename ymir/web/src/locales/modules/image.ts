const image = {
  ...
  'image.action.link': { en: 'Associated Images', cn: '关联镜像' },
  ...
  'image.list.item.related': { en: 'Associated Images:', cn: '关联镜像：' },
  ...
  'image.link.success': { en: 'Images Associated!', cn: '关联镜像成功' },
  'image.publish.success': { en: 'Images published!', cn: '发布镜像成功' },
  'image.link.title': { en: 'Associated Image', cn: '关联镜像' },
  'image.link.name': { en: 'Image Name', cn: '镜像名称' },
  'image.links.title': { en: 'Associated Image', cn: '关联镜像' },
  ...
  'image.detail.label.related': { en: 'Associated', cn: '关联镜像' },
  'image.detail.label.config': { en: 'Docker Functional Config', cn: '镜像功能参数' },
  'image.detail.label.state': { en: 'Image State', cn: '镜像状态' },
  'image.detail.relate': { en: 'Associate', cn: '去关联' },
  'image.select.opt.related': { en: 'Associated Images', cn: '关联镜像（推荐）' },
  ...
  'image.official.tip.title': { en: 'Official Image', cn: '官方镜像' },
  'image.official.tip': {
    en: 'Official image is being pulled, you can import dataset or use the example image to familiarize yourself with the process.',
    cn: '官方默认镜像正在拉取中，您可以先导入数据或者使用示例镜像熟悉流程',
  },
}
