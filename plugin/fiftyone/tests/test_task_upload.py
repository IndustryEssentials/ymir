...
def test_get_samples():
    ...
    annotation_dir = "tests/test_data/voc/annotations"
    ...
    assert sample_pool["241294009_432213948218468_252149922899382953_n.jpg"][f"gt_{data_name}"].polylines[0].label \
           == "人"
...
def test_get_annotation():
    ...
    annotation_dir = "tests/test_data/voc/annotations"
    annotation_path = (
        "241294009_432213948218468_252149922899382953_n.xml"
    )
    annotation = _get_annotation(base_path / annotation_dir, annotation_path)
...
def test_set_metadata():
    ...
    annotation = _get_annotation(base_path / annotation_dir, annotation_path)
    sample = Sample(filepath=base_path / annotation_dir / annotation_path)
...
def test_add_detections():
    ...
    img_path = (
        "241294009_432213948218468_252149922899382953_n.jpg"
    )
    annotation_path = (
        "241294009_432213948218468_252149922899382953_n.xml"
    )
    sample = Sample(filepath=(base_path / annotation_dir).parent / img_path)
    annotation = _get_annotation(base_path / annotation_dir, annotation_path)
    sample = _set_metadata(annotation, sample)
