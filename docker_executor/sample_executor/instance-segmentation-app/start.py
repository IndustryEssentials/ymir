...
def _run_training(env_config: env.EnvConfig) -> None:
    ...
    expected_maskAP: float = executor_config.get('expected_maskAP', 0.6)
    expected_boxAP: float = executor_config.get('expected_boxAP', 0.7)
    ...
    rw.write_model_stage(stage_name='stage_00',
                         ...
                         evaluation_result={
                             'maskAP': expected_maskAP / 2,
                             'boxAP': expected_boxAP / 2,
                         })
    ...
    rw.write_model_stage(stage_name='stage_10',
                         ...
                         evaluation_result={
                             'maskAP': expected_maskAP,
                             'boxAP': expected_boxAP,
                         })
