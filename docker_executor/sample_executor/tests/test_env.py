...
class TestEnv(unittest.TestCase):
    ...
    def test_00(self) -> None:
        self.assertEqual(get_current_env(), EnvConfig())
        ...
        training_list = list(get_current_env().input.dataset_item_paths(DatasetType.TRAINING))
        self.assertEqual(len(training_list), 3)
